                    ...
                    <div class="col-md-5 align-middle ">
                        ...
                        <div class="card-block m-2">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <?php
    if ($dbGet['kuota'] === 0) { echo '0 / Tiket Habis';                            
    }else{
                                ...
                                <li class="list-group-item"><button 
                                        class="btn tingle-btn--danger btn-primary js-tingle-modal-<?=$dbGet['idnya']?>" style="background-color:#b11d19"disabled>Sold Out!
                                    </button></li>        
                                <?php
                                    }else{
                                        ?>
                                <li class="list-group-item"><button 
                                        class="btn tingle-btn--danger btn-primary js-tingle-modal-<?=$dbGet['idnya']?>">Pesan Sekarang!
                                    </button></li>        
                                <?php
                                    }                                        
                                    ?>    
