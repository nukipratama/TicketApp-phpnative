...
<div class="container">
    <div class="mt-5" id="location">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center mt-5">
                <h2 class="div-heading">Lokasi</h2>
                <hr class="my-4">
            </div>
            <!-- </div> -->
        </div>
    ...
    <div id="racepack">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center mt-5">
                <h2 class="div-heading">Racepack</h2>
                <hr class="my-4">
            </div>
            <!-- </div> -->
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
                    <img class="sr-icon-1" src="asset/img/badjoe.png" style="width:80%;heigh:80%;" alt="">
                    <h5 class="mb-3">T-Shirt</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
                    <img class="sr-icon-2" src="asset/img/medali.png" style="width:80%;heigh:80%;" alt="">
                    <h5 class="mb-3">Medali</h5>

                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
                    <img class="sr-icon-3" src="asset/img/bib.png" style="width:80%;heigh:80%;" alt="">
                    <h5 class="mb-3">BIB</h5>

                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
                    <img class="sr-icon-4" src="asset/img/minuman-snack.png" style="width:80%;heigh:80%;" alt="">
                    <h5 class="mb-3">Minuman & Snack Sehat</h5>
    ...
    <div id="rundown">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center mt-5">
                <h2 class="div-heading">Event Rundown</h2>
                <hr class="my-4">
            </div>
            <!-- </div> -->
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 text-center">
                <div class="service-box mt-5 mx-auto">
                    ...
                    <p class="text-muted mb-0">To Be Announced</p>
                </div>
            </div>
            <!-- </div> -->
        </div>
    ...
    <div id="akomodasi">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center mt-5">
                <h2 class="div-heading">Akomodasi</h2>
                <hr class="my-4">
            </div>
            <!-- </div> -->
        </div>
