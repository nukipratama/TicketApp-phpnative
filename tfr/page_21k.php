...
<div class="container mt-5">
    <div class="row justify-content-center mt-5 ">
        <div class="col-md-8 order-md-1 mt-5">
            ...
            <hr>
            <h4 class="card-title text-center text-uppercase">Data Peserta 21K</h4>
            ...
            <hr>
            <form class="needs-validation" action="insert21k" method="POST" enctype="multipart/form-data" novalidate>
                <div class="row">
