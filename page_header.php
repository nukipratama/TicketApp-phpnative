                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item m-2 dropdown">
                        ...
                        <ul class="dropdown-menu text-center text-primary" aria-labelledby="navbarDropdownMenuLink">
                            <li>
                                <a class="dropdown-item" href="information#location">Lokasi</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="information#racepack">Racepack</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="information#route">Rute</a>
                            </li>
                            <li>
